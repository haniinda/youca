...
class CreateAdvserviceCategoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('advservice_category', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('advservice_category');
    }
}
